...
// Tests commented since they only work when --nocapture is passed
// as argument to cargo test

// #[cfg(test)]
// mod tests {
//     use super::StdioCapturer;

//     #[test]
//     fn test_capture_works() {
//         let c = StdioCapturer::new();
//         println!("PRINT1");
//         println!("PRINT2");
//         let (stdout, stderr) = c.end();
//         assert_eq!(stdout, "PRINT1\nPRINT2\n");
//         assert_eq!(stderr, "");
//     }
// }
